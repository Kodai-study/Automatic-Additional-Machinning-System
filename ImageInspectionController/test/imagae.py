    ...
    if circles is not None:
        ...
        for i, circle in enumerate(circles[0, :]):
            ...
            for existing_circle in detected_circles:
                ...
                distance = np.sqrt(
                    (center[0] - existing_center[0])**2 + (center[1] - existing_center[1])**2)
            ...
            if not overlap:
                ...
                # TTFフォントを指定して読み込む
                # フォントのパスを指定してください
                font_path = "ImageInspectionController/test/NotoSansJP-VariableFont_wght.ttf"
                font_size = 14
                ...
                text_position = (center[0] + radius +
                                 10, center[1] - radius - 10)
...
def main():
    ...
    detected_circles, detected_black_rectangles, output_image_path = detect_and_draw_shapes(
        image_path, max_circles=5, max_rectangles=5)
