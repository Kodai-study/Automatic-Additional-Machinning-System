...
class Taking:
    def take_picuture(self,kensamei:InspectionType)->str:
        ...
        if InspectionType == InspectionType.TOOL_INSPECTION:
        ...
        cam_system=self.initial_cam_setting(1)
        cam_device,receive_signal=self.setting_cam(serial_number,model_number,cam_system)
