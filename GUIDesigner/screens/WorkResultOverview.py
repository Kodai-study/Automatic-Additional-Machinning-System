...
class WorkResultOverview:
    ...
    def create_frame(self, selected_items):
        ...
        tree = ttk.Treeview(self.frame, columns=("ID", "Model", "Processing Time", "Shape",
        ...
        scrollbar = tk.Scrollbar(
            self.frame, orient=tk.VERTICAL, command=tree.yview)
        tree.config(yscrollcommand=scrollbar.set)

        kakunin_button = tk.Button(
            self.frame, text="確認", command=self.back_to_selection_frame, font=("AR丸ゴシック体M", 24), width=22)
